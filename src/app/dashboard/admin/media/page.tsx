...
export default function MediaPage() {
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div>
        <h1 className="font-heading text-3xl font-extrabold tracking-tight capitalize">Media</h1>
        <p className="text-muted-foreground font-medium mt-1">Manage Media configuration and settings.</p>
      </div>
      ...
      <div className="bg-white border-2 border-border border-dashed rounded-[2rem] h-96 flex flex-col items-center justify-center text-center p-8">
        ...
        <p className="text-muted-foreground font-medium max-w-sm">
          The Media module is currently being built. Check back soon for the full feature set.
        </p>
      </div>
    </div>
  );
