    ...
    <div className="bg-white rounded-[2rem] border-2 border-border shadow-md overflow-hidden flex flex-col h-[calc(100vh-8rem)] sticky top-24">
      <div className="p-6 border-b-2 border-border bg-muted/20">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-primary rounded-xl border-2 border-border shadow-sm flex items-center justify-center text-primary-foreground font-heading font-extrabold text-xl">
            {userName.charAt(0)}
          </div>
          <div className="overflow-hidden">
            <h3 className="font-bold text-lg truncate">{userName}</h3>
            <p className="text-sm font-medium text-muted-foreground truncate">Candidate</p>
          </div>
        </div>
      </div>
